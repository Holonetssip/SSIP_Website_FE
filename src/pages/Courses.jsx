...
const allCourses = [
  ...
  {
    id: "bpsc-1", category: "BPSC", title: "BPSC 2026",
    desc: "BPSC Prelims 2026 Preparation Now in Fast Track Mode. Seats are limited and batches fill very fast.",
    price: "1,299", oldPrice: "₹2,999", rating: "New", students: "Filling Fast",
    duration: "Foundation", isClosed: false,
    img: "https://courses-assets-v2.classplus.co/_next/image?url=/api/proxyimage?url=https%3A%2F%2Fcdn-wl-assets.classplus.co%2Fproduction%2Fsingle%2Fkedvtr%2F5a3ac70b-d0bc-4b86-a5d1-1e5c6071c97f.jpg&w=384&q=75",
    link: "https://www.ssip.cloud/courses/814576?mainCategory=142669"
  },
  {
    id: "mppsc-1", category: "MPPSC", title: "MPPSC 2026",
    desc: "Integrated MPPSC preparation.",
    price: "1,299", oldPrice: "₹1,999", rating: "New", students: "Filling Fast",
    duration: "Foundation", isClosed: false,
...
// --- UPDATED CATEGORIES ---
const categories = ["All", "UPSC Mains", "UPSC Prelims", "UPPCS Prelims", "UPPCS Mains", "Mentorship", "MPPSC", "BPSC", "UKPCS", "RAS"];
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto 2xl:px-8">
        ...
        <AnimatePresence mode="wait">
          ...
          >
            {activeCategory === "All" ? (
              <>
                <CourseRow title="UPSC Mains Batches" courses={allCourses.filter(c => c.category === "UPSC Mains")} />
