...
const Home = () => {
  ...
  const testimonials = [
    ...
    { name: "Somya Kulshreshtha", rank: "2nd in ARTO", text: "Great teachers here are real strategists. They not only provide content but also teach how to present it effectively in answers.The current affairs tricks and mnemonic techniques were amazing.I’m really thankful to Saurabh Sir and the whole SSIP team for making this journey much easier. I was part of UPPSC Spark.", avatar: "S", image: gs },
  ...
  const featuredCourses = [
    ...
    { id: "uppcs-p-5", category: "UPPCS Prelims", title: "Granth 2.0", desc: "All subjects GHATNA CHAKRA & lucent coverage through tricks & nemonic for retention.", img: "https://courses-assets-v2.classplus.co/_next/image?url=/api/proxyimage?url=https%3A%2F%2Fcdn-wl-assets.classplus.co%2Fproduction%2Fsingle%2Fkedvtr%2F71d35ae1-c133-4273-9000-4fa341611bfe.png&w=384&q=75", link: "https://www.ssip.cloud/courses/770985?filterId=1&sortId=7", price: "₹2,499", oldPrice: "₹4,999", badge: "Trending" },
    { id: "uppcs-m-1", category: "UPPCS Mains", title: "MAHAGRANTH", desc: "The definitive Mains coverage batch. Deep dive into all GS papers with blueprint techniques & tricks.", img: "https://courses-assets-v2.classplus.co/_next/image?url=/api/proxyimage?url=https%3A%2F%2Fcdn-wl-assets.classplus.co%2Fproduction%2Fsingle%2Fkedvtr%2F8287d028-202c-441b-990d-f49b7224190d.png&w=384&q=75", link: "https://www.ssip.cloud/courses/770999?filterId=1&sortId=7", price: "₹3,999", oldPrice: "₹9,999", badge: "Flagship" },
    { id: "uppcs-p-4", category: "UPPCS Prelims", title: "CAC 3.0", desc: "Monthly Current Affairs Compilation version 3.0 optimized for UPPCS specific events including lectures & notes.", img: "https://courses-assets-v2.classplus.co/_next/image?url=/api/proxyimage?url=https%3A%2F%2Fcdn-wl-assets.classplus.co%2Fproduction%2Fsingle%2Fkedvtr%2Fcb831c14-7671-4fbb-a352-3b242af51c38.png&w=384&q=75", link: "https://www.ssip.cloud/courses/770996?filterId=1&sortId=7", price: "₹499", oldPrice: "₹1,499", badge: "Best Seller" }
  ];
